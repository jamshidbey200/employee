...
const UserDetail = () => {
  ...
  const { mutate: createUser, isLoading: createLoading } = useUserCreateMutation({
    onSuccess: () => {
      successToast()
      navigate(-1)
    }
    ...
    <form onSubmit={handleSubmit(onSubmit)} >
      ...
      <Page p={4} h="calc(100vh - 56px)">
        <PageCard w={600}>
          ...
          <PageCardFooter mt={6}>
            <Button isLoading={createLoading || updateLoading} type="submit" ml="auto">Сохранить</Button>
          </PageCardFooter>
        </PageCard>
      </Page>
    </form>
